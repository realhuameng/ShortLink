...
public class UserTableShardingTest {
    ...
    public static final String SQL = "CREATE TABLE `t_link_%d`  (\n" +
            ...
            "  `click_num` int(11) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '点击量',\n" +
            "  `gid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'default' COMMENT '分组ID',\n" +
